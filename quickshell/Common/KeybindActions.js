...
const DMS_ACTIONS = [
    ...
    { id: "spawn dms ipc call aiassistant toggle", label: "AI Assistant: Toggle" },
    { id: "spawn dms ipc call aiassistant open", label: "AI Assistant: Open" },
    { id: "spawn dms ipc call aiassistant close", label: "AI Assistant: Close" },
