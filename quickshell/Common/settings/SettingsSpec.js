...
var SPEC = {
    ...
    aiAssistantProvider: { def: "openai" },
    aiAssistantBaseUrl: { def: "https://api.openai.com" },
    aiAssistantModel: { def: "gpt-4.1-mini" },
    aiAssistantTemperature: { def: 0.7 },
    aiAssistantMaxTokens: { def: 2048 },
    aiAssistantTimeout: { def: 30 },
    aiAssistantTransparencyOverride: { def: -1 },
    aiAssistantLastCustomTransparency: { def: 0.7 },
    aiAssistantUseMonospace: { def: true },
